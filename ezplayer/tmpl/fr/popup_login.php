...
<div id="popup_login" class="reveal-modal down">
    <h2>Se connecter</h2>
    <br/><p>En vous identifiant, vous aurez accès à plus de possibilités, telles que l’ajout de signets sur les vidéos, le partage d’un moment précis d’une vidéo, l’import/export de signets, la gestion de vos cours favoris, etc.</p>
    ...
    <form name="login_form" action="<?php global $ezplayer_safe_url; echo $ezplayer_safe_url; ?>/index.php" method="post">
        ...
        <br />
        <a href="#" onclick="document.login_form.submit(); return false;" class="simple-button" title="Connexion à EZplayer">Connexion</a>
        <a class="close-reveal-modal-button">Annuler</a>
        <br />
    </form>
</div>
