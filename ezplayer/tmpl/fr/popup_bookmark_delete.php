...
<br/><p>Attention, vous vous apprêtez à supprimer un signet. Cette opération est irréversible.</p>
<a class="close-reveal-modal" href="javascript:close_popup();">&#215;</a>
<br/>
<a href="javascript:bookmark_delete('<?php echo $bookmark['album'] ?>', '<?php echo $bookmark['asset'] ?>', '<?php echo $bookmark['timecode'] ?>', '<?php echo $source ?>', '<?php echo $tab ?>');" class="delete-button-confirm">Supprimer</a>
