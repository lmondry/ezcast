...
<div id="side_menu">
    ...
    <?php if (acl_user_is_logged()) { ?>
        <div class="bookmarks_button active dir"><a onclick="setActivePane('.bookmarks_button');
            server_trace(new Array('2', 'bookmarks_swap', current_album, current_asset, current_tab));" href="#album_bookmarks" title="Afficher les signets de l'album"></a></div>
            <?php
        }
        ?>
    <div class="toc_button dir"><a onclick="setActivePane('.toc_button');
        server_trace(new Array('2', 'bookmarks_swap', current_album, current_asset, current_tab));" href="#album_toc" title="Afficher les signets officiels"></a></div>
    <div class="settings bookmarks"> 
        ...
        <a class="sort-button <?php echo acl_value_get("personal_bm_order"); ?>" title="Inverser l'ordre des signets" href="javascript:bookmarks_sort('personal', '<?php echo (acl_value_get("personal_bm_order") == "chron") ? "reverse_chron" : "chron"; ?>', 'assets');"></a>
        <ul id="bookmarks_actions">
            <li><a href="javascript:popup_bookmarks('<?php echo $album; ?>', '', 'custom', 'assets', 'export')" title="Exporter les signets du cours">Exporter les signets</a></li>  
            <li><a href="javascript:popup_bookmarks_import();" title="Importer les signets du cours">Importer les signets</a></li>
            <li><a href="javascript:popup_bookmarks('<?php echo $album; ?>', '', 'custom', 'assets', 'delete')" title="Supprimer les signets liés à ce cours">Supprimer les signets</a></li>                          
        </ul>
    </div>    
    <div class="settings toc">
        ...
        <a class="sort-button <?php echo acl_value_get("official_bm_order"); ?>" title="Inverser l'ordre des signets" href="javascript:bookmarks_sort('official', '<?php echo (acl_value_get("official_bm_order") == "chron") ? "reverse_chron" : "chron"; ?>', 'assets');"></a>
        <ul id="tocs_actions">
            <li><a href="javascript:popup_bookmarks('<?php echo $album; ?>', '', 'official', 'assets', 'export')" title="Exporter les signets du cours">Exporter les signets</a></li>  
            <?php if (acl_user_is_logged() && acl_has_album_moderation($album)) { ?>
                <li><a href="javascript:popup_bookmarks_import();" title="Importer les signets du cours">Importer les signets</a></li>
                <li><a href="javascript:popup_bookmarks('<?php echo $album; ?>', '', 'official', 'assets', 'delete')" title="Supprimer les signets liés à ce cours">Supprimer les signets</a></li>                          
            <?php } ?>
        </ul>
    </div>
</div>
                            ...
                            <li id="bookmark_<?php echo $index; ?>" class="blue level_<?php echo $bookmark['level']; ?>">
                                ...
                                <div class="bookmark_detail" id="bookmark_detail_<?php echo $index; ?>">
                                    ...
                                    <div class="bookmark_options">
                                        <a class="delete-button" title="Supprimer le signet" href="javascript:popup_bookmark('<?php echo $bookmark['album']; ?>', '<?php echo $bookmark['asset']; ?>', '<?php echo $bookmark['timecode']; ?>', 'custom', 'assets', 'remove')"></a>
                                    </div>
                                </div>
                            </li>
                            <?php
                    ...
                    foreach ($official_bookmarks as $index => $bookmark) {
                        ...
                        <li id="toc_<?php echo $index; ?>" class="orange level_<?php echo $bookmark['level']; ?>">
                            ...
                            <div class="bookmark_detail" id="toc_detail_<?php echo $index; ?>">
                                ...
                                <?php if (acl_user_is_logged() && acl_has_album_moderation($album)) { ?>
                                    <div class="bookmark_options">
                                        <a class="delete-button" title="Supprimer le signet" href="javascript:popup_bookmark('<?php echo $bookmark['album']; ?>', '<?php echo $bookmark['asset']; ?>', '<?php echo $bookmark['timecode']; ?>', 'official', 'assets', 'remove')"></a>
                                    </div>
                                <?php } ?>
                            </div>
                        </li>
