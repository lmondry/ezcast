...
<?php } ?>
<br/><p>Sélectionnez les signets que vous souhaitez exporter</p>
...
<?php if (isset($bookmarks) && count($bookmarks) > 0) { ?>
    <form action="index.php?action=bookmarks_export" method="post" id="select_export_bookmark_form" name="export_bookmark_form" onsubmit="return false">
        ...
        <ul>
            <li style="border-bottom: solid 1px #cccccc;"><input type="checkbox" onclick="toggle_checkboxes(this, 'export_selection[]')" name="check_all"/><span class="<?php echo (($tab == 'custom') ? 'blue-title' : 'orange-title'); ?>"><b>Date</b></span><span class="<?php echo (($tab == 'custom') ? 'blue-title' : 'orange-title'); ?>"><b>Signet</b></span></li>
        ...
        <a href="#" onclick="document.export_bookmark_form.submit(); close_popup();
                return false;" id="export_button" class="simple-button blue" title="Exporter les signets sélectionnés">Exporter</a>
