...
<h3>Soumettre un fichier contenant des signets :</h3>
<br/>
<p>Sélectionnez un fichier XML contenant les signets que vous souhaitez importer.</p>
<br/>
<script>
    ...
    <form name="upload_bookmarks" target="" action="#" method="post" id="submit_import_form" enctype="multipart/form-data" onsubmit="return false">
        ...
        <div style="margin-left: 75px;">
            <label id="loadingfile_label"> 
                Fichier&nbsp;:
                <span class="small" style="margin-left: -32px">Max. 2Mo</span>
            </label>
        ...
        <!-- Submit button -->
        <br/>
        <a class="simple-button" style="clear:both;" href="javascript: if(bookmarks_upload_form_check()) bookmarks_upload_form_submit()">Soumettre</a>
