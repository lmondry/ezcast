    ...
    <div id="advanced_search">
        ...
        <div class="search_current">
            <?php if (isset($_SESSION['album']) && $_SESSION['album'] != '') { ?>
                La recherche porte uniquement sur le cours "<strong><?php echo suffix_remove($_SESSION['album']); ?></strong>"
                <?php if (isset($_SESSION['asset']) && $_SESSION['asset'] != '') { ?>
                     dans l'enregistrement "<strong><?php echo get_asset_title($_SESSION['album'], $_SESSION['asset']); ?></strong>".
                <?php } ?>
            <?php } else { ?>
                La recherche porte sur tous vos cours
            <?php } ?>
        </div> 
