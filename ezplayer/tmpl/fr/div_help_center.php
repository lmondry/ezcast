...
<div id="help-content">
    ...
    <p>Ce tutoriel existe au format .pdf ; vous pouvez le télécharger dans l'espace étudiants du site 
        "<a href="http://podcast.ulb.ac.be/site/PDF_DOC/Tutoriel_EZplayer.pdf">Your organization Podcast</a>"</p>
    <ul id="topics">
        <li>
            ...
            <div>
                <p>«<b>EZplayer</b>» est une interface vous permettant de visualiser les vidéos enregistrées en auditoire 
                    ou soumises par vos professeurs au moyen de la solution «<b> Your organization Podcast </b>». En plus d’être un lecteur 
