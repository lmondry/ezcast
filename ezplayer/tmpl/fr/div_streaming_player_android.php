        ...
        <div class="video_controls streaming">
            <ul>
                ...
                <?php if ($asset_meta['record_type'] === 'camslide') { ?>
                    <li>
                        <a class="movie-button <?php echo ($_SESSION['current_type'] === 'cam') ? 'active' : ''; ?>" title="Regarder la vidéo" href="javascript:switch_prepare('cam');"></a>
                        <a class="slide-button <?php echo ($_SESSION['current_type'] === 'slide') ? 'active' : ''; ?>" title="Regarder le diaporama" href="javascript:switch_prepare('slide');"></a>
                    </li>
                <?php } ?>
                <li>
                    <a class="fullscreen-button" href="javascript:player_streaming_fullscreen(!fullscreen);" title="Modifier l'affichage" ></a>
                </li>   
                <li>
                    <a class="panel-button active" title="Réduire / agrandir le chat" href="javascript:chat_resize();"></a>
                </li>
            </ul>
        </div>
    </div>
