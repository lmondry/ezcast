...
<div class="form" id="thread_form">
    ...
    <div id="thread_form_header">
        ...
        <span class="form_header_label">Create a discussion</span>
    </div>
    <div id='thread_form_wrapper'>
        ...
        <form action="index.php" method="post" id="submit_thread_form" onsubmit="return false">
            ...
            <input name="title" tabindex='18' id="thread_title" type="text" placeholder="Subject of the discussion" maxlength="140"/>
