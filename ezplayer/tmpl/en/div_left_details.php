    ...
    <div id="video_player" class="remove_full">
        ...
        <div id="video_shortcuts">
            <div class="shortcuts">
                <ul>
                    ...
                    <li><span class="key back-next"></span><span>Back / Next</span></li>
                    <li><span class="key speed"></span><span>Fast forward</span></li>
                    <li><span class="key volume"></span><span>Audio volume</span></li>
                    <li><span class="key m"></span><span>Mute</span></li>
                    <li><span class="key s"></span><span>Switch cam / slide</span></li>
                    <li><span class="key n"></span><span>New bookmark</span></li>
                    <li><span class="key d"></span><span>New discussion</span></li>
                    <li><span class="key shift"></span><span>Display bookmarks</span></li>
        ...
        <?php if (acl_display_thread_notification()) { ?>
            ...
            <div id='video_notifications'>
                <div class='notifications_title'><b>Current discussions</b></div>
        ...
        <div id="load_warn">Both videos must be loaded to enable the switch function. Press "Play" to load this video.</div>
...
<?php if ($playbackRate) { ?>
                ...
                if (isset($asset_meta['record_type']) && $asset_meta['record_type'] == 'camslide') {
                    ?>
                    <li>
                        <a class="movie-button active" title="Watch the video" href="javascript:player_video_type_set('cam');"></a>
                        <a class="slide-button" title="Watch the slides" href="javascript:player_video_type_set('slide');"></a>
                    </li>
<?php } ?>
                <li>
                    <a class="high-button" title="Watch high resolution" href="javascript:player_video_quality_set('high');"></a>
                    <a class="low-button active" title="Watch low resolution" href="javascript:player_video_quality_set('low');"></a>
                </li>
                    <?php if (acl_user_is_logged()) { ?>
                    <li>
                        <?php if (acl_has_album_permissions($album)){ ?>
                        <a class="add-bookmark-button" title="Create a private bookmark" href="javascript:player_bookmark_form_toggle('personal');"></a>
                        <?php }
                        if (acl_has_album_moderation($album) || acl_is_admin()) { ?>
                            <a class="add-toc-button" title="Create an official bookmark" href="javascript:player_bookmark_form_toggle('official');"></a>
                            <?php
                        }
