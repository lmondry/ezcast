        ...
        <div class="video_controls streaming">
            <ul>
                ...
                <?php if ($asset_meta['record_type'] === 'camslide') { ?>
                    <li>
                        <a class="movie-button <?php echo ($_SESSION['current_type'] === 'cam') ? 'active' : ''; ?>" title="Watch the video" href="javascript:switch_prepare('cam');"></a>
                        <a class="slide-button <?php echo ($_SESSION['current_type'] === 'slide') ? 'active' : ''; ?>" title="Watch the slides" href="javascript:switch_prepare('slide');"></a>
                    </li>
                <?php } ?>
                <li>
                    <a class="fullscreen-button" href="javascript:player_streaming_fullscreen(!fullscreen);" title="Change the display" ></a>
                </li>   
                <li>
                    <a class="panel-button active" title="Reduce / Enlarge the chat" href="javascript:chat_resize();"></a>
                </li>
            </ul>
        </div>
    </div>
