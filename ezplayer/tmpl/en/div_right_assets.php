...
<div id="side_menu">
    ...
    <?php if (acl_user_is_logged()) { ?>
        <div class="bookmarks_button active dir"><a onclick="setActivePane('.bookmarks_button');
            server_trace(new Array('2', 'bookmarks_swap', current_album, current_asset, current_tab));" href="#album_bookmarks" title="Display the album bookmarks"></a></div>
            <?php
        }
        ?>
    <div class="toc_button dir"><a onclick="setActivePane('.toc_button');
        server_trace(new Array('2', 'bookmarks_swap', current_album, current_asset, current_tab));" href="#album_toc" title="Display official bookmarks"></a></div>
    <div class="settings bookmarks"> 
        ...
        <a class="sort-button <?php echo acl_value_get("personal_bm_order"); ?>" title="Reverse bookmarks order" href="javascript:bookmarks_sort('personal', '<?php echo (acl_value_get("personal_bm_order") == "chron") ? "reverse_chron" : "chron"; ?>', 'assets');"></a>
        <ul id="bookmarks_actions">
            <li><a href="javascript:popup_bookmarks('<?php echo $album; ?>', '', 'custom', 'assets', 'export')" title="Export the related bookmarks">Export the bookmarks</a></li>  
            <li><a href="javascript:popup_bookmarks_import();" title="Import the related bookmarks">Import the bookmarks</a></li>
            <li><a href="javascript:popup_bookmarks('<?php echo $album; ?>', '', 'custom', 'assets', 'delete')" title="Delete bookmarks related to this course">Delete the bookmarks</a></li>                          
        </ul>
    </div>    
    <div class="settings toc">
        ...
        <a class="sort-button <?php echo acl_value_get("official_bm_order"); ?>" title="Reverse bookmarks order" href="javascript:bookmarks_sort('official', '<?php echo (acl_value_get("official_bm_order") == "chron") ? "reverse_chron" : "chron"; ?>', 'assets');"></a>
        <ul id="tocs_actions">
            <li><a href="javascript:popup_bookmarks('<?php echo $album; ?>', '', 'official', 'assets', 'export')" title="Export the related bookmarks">Export the bookmarks</a></li>  
            <?php if (acl_user_is_logged() && acl_has_album_moderation($album)) { ?>
                <li><a href="javascript:popup_bookmarks_import();" title="Import the related bookmarks">Import the bookmarks</a></li>
                <li><a href="javascript:popup_bookmarks('<?php echo $album; ?>', '', 'official', 'assets', 'delete')" title="Delete bookmarks related to this course">Delete the bookmarks</a></li>                          
            <?php } ?>
        </ul>
    </div>
</div>
                            ...
                            <li id="bookmark_<?php echo $index; ?>" class="blue level_<?php echo $bookmark['level']; ?>">
                                ...
                                <div class="bookmark_detail" id="bookmark_detail_<?php echo $index; ?>">
                                    ...
                                    <div class="bookmark_options">
                                        <a class="delete-button" title="Delete the bookmark" href="javascript:popup_bookmark('<?php echo $bookmark['album']; ?>', '<?php echo $bookmark['asset']; ?>', '<?php echo $bookmark['timecode']; ?>', 'custom', 'assets', 'remove')"></a>
                                    </div>
                                </div>
                            </li>
                            <?php
                ...
                <ul class="toc_scroll">
                    ...
                    foreach ($official_bookmarks as $index => $bookmark) {
                        ...
                        <li id="toc_<?php echo $index; ?>" class="orange level_<?php echo $bookmark['level']; ?>">
                            ...
                            <span class="more"><a class="more-button orange" onclick="bookmark_more_toggle('<?php echo $index; ?>', 'toc', $(this));"></a></span>
                            <div class="bookmark_detail" id="toc_detail_<?php echo $index; ?>">
                                ...
                                <?php if (acl_user_is_logged() && acl_has_album_moderation($album)) { ?>
                                    <div class="bookmark_options">
                                        <a class="delete-button" title="Delete the bookmark" href="javascript:popup_bookmark('<?php echo $bookmark['album']; ?>', '<?php echo $bookmark['asset']; ?>', '<?php echo $bookmark['timecode']; ?>', 'official', 'assets', 'remove')"></a>
                                    </div>
                                <?php } ?>
                            </div>
                        </li>
