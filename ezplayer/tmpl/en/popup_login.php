...
<div id="popup_login" class="reveal-modal down">
    <h2>Connect</h2>
    <br/><p>By authenticating, you have access to more features, such as adding bookmarks on the videos, sharing a specific moment in the video, importing/exporting bookmarks, handling your favorite courses, etc.</p>
    ...
    <form name="login_form" action="<?php global $ezplayer_safe_url; echo $ezplayer_safe_url; ?>/index.php" method="post">
        ...
        <br />
        <a href="#" onclick="document.login_form.submit(); return false;" class="simple-button" title="Log in to EZplayer">Log in</a>
