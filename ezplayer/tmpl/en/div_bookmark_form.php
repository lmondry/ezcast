...
<div class="form" id="bookmark_form">
    <div id="bookmark_form_header" class="bookmark-color">
        ...
        <span class="form_header_label" >Create a private bookmark</span>
    </div>
    <div id="bookmark_form_header" class="toc-color">
        <span id="bookmark_form_header_logo" class="toc-logo"></span>
        <span class="form_header_label" >Create an official bookmark</span>
    </div>
    <div id='bookmark_form_wrapper'>
        <form action="index.php" method="post" id="submit_bookmark_form" onsubmit="return false">
            ...
            <!-- keywords field -->
            <label>Keywords&nbsp;:
                <span class="small">Comma separated values</span>
            </label>
            ...
            <!-- level field -->
            <label>Level&nbsp;:
                <span class="small">Level of the bookmark</span>
            </label>
            ...
            <div class="submitButton">
                <a id="subBtn" class="button" tabindex='17' href="javascript: if(bookmark_form_check()) bookmark_form_submit();">Add bookmark</a>
            </div>
            <br />
        </form>
    </div>
