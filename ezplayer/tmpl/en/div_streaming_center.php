...
<div id="main_player" class="small_display">
    ...
    <div id="site_map">
        ...
        if (acl_has_album_permissions($album)) {
            ...
            <a  href="javascript:player_kill();show_album_assets('<?php echo $album; ?>', '<?php echo $token; ?>');" title="Back to the album">(<?php echo suffix_remove($album); ?>) <?php echo get_album_title($album); ?></a>   
        <?php } ?>
