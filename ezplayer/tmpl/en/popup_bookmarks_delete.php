...
?> 
    ...
    <?php } ?>
    <br/><p>Select the bookmarks to be deleted. This operation can't be reverted.</p>
    ...
    <form action="index.php?action=bookmarks_delete" method="post" id="select_delete_bookmark_form" name="delete_bookmarks_form" onsubmit="return false">
        ...
        <a href="#" onclick="bookmarks_delete_form_submit('<?php echo $source; ?>');" id="delete_button" class="delete-button-confirm" title="Delete the selected bookmarks">Delete</a>
