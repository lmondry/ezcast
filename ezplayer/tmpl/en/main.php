        ...
        <script>
            ...
            function bookmark_form_check() {
                ...
                if (isNaN(timecode.value)
                        || timecode.value == ''
                        || timecode.value < 0) {
                    window.alert('Incorrect timecode');
                    return false;
                }
                ...
                if($.inArray(parseInt(timecode.value), liste) >= 0) {
                    window.alert("A bookmarks already exist for this time");
                    return false;
                }
                ...
                if (isNaN(level.value)
                        || level.value < 1
                        || level.value > 3) {
                    window.alert('Incorrect level. The level must be a number between 1 and 3');
                    return false;
                }
                return true;
            }
            ...
            <div id="warning">
                <div>
                    <a href="#" onclick="document.getElementById('warning').style.display = 'none';
                       ">&#215;</a>
                    This site is not optimized for your web browser. Some functionalities might not properly work.
                    <br />Only the following browsers are fully compatible :
                    <ul>
                        <li><b>Safari 5+</b> | </li>
