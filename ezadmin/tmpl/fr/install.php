...
<html lang="en">
    <head>
        ...
        <title>Installation EZcast</title>
        ...
        <div class="container_ezplayer">
            ...
            ?>
                ...
                <div class="wizard">
                        ...
                        <div class="panel-body well" style="margin-bottom:0;">
                            <div class="row">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">URL d'application</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <label class="checkbox">
                                                ...
                                                Site utilisant le protocol https
                                            </label>
                                    ...
                                    <div class="control-group">
                                            <label class="control-label">URL de l'organisation</label>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label">Logo de l'organisation
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Chemin racine du dépôt</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Chemin racine de l'application</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Commande rsync</label>
                                        <div class="controls">
                    ...
                    <div class="panel">
                        <div class="panel-heading btn input-block-level">
                            <h4>Options de la base de données</h4>
                        </div>    
                        ...
                        <div class="panel-body well" style="margin-bottom:0;">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Nom de la base de donnée</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Préfixe</label>
                                        <div class="controls">
                    ...
                    <div class="panel">
                        <div class="panel-heading btn input-block-level">
                            <h4>Options de l'enregistreur</h4>
                        </div>    
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <label class="checkbox">
                                                ...
                                                Activer la gestion des auditoires
                                            </label>
                ...
                <div class="form-actions">
                    <input type="submit" name="install" value="Installer" class="btn btn-primary"/>
                    <input type="reset" name="install" value="Effacer" class="btn"/>
                </div>
            </form>
        </div>
