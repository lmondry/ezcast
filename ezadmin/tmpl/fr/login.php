                    ...
                    <?php if (isset($_SESSION['install'])) { ?>
                        ...
                        <?php } else { ?>
                            ...
                            ?>/index.php" method="post" onsubmit="detect_flash();">
                                  <?php } ?>
                                  <?php if (isset($_SESSION['install'])) { ?>
                                <h4>Interface d'installation d'EZcast</h4>
                            <?php } ?>
                            ...
                            <div id="login_fields">
                                ...
                                <br/>
                                <label>Mot de passe:&nbsp;&nbsp;</label><input type="password" name="passwd" autocapitalize="off" autocorrect="off" tabindex="2" />
                            </div>
                            ...
                            <br/>
                            <a style="font-size: 0.8em;" href="javascript:unsafe_connection();" title="Connexion non sécurisée">Connexion non cryptée</a>
