...
<div class="table-responsive">
    <table class="table table-striped table-hover table-bordered table-condensed events sort_col">
        <tr>
            ...
            <?php echo $colOrder->insertThSort("origin", "Origine"); ?>
            <?php echo $colOrder->insertThSort("classroom_id", "Auditoire"); ?>
            <?php echo $colOrder->insertThSort("course", "Cours"); ?>
            <?php echo $colOrder->insertThSort("author", "Auteur"); ?>
            <?php echo $colOrder->insertThSort("cam_slide", "C/S"); ?>
            <?php echo $colOrder->insertThSort("event_time", "Date"); ?>
            <?php echo $colOrder->insertThSort("type_id", "Type"); ?>
            <?php echo $colOrder->insertThSort("context", "Contexte"); ?>
            <?php echo $colOrder->insertThSort("loglevel", "LogLevel"); ?>
            <?php echo $colOrder->insertThSort("message", "Message"); ?>
        </tr>
