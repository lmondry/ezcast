<div class="page_title">Historique des opérations</div>
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-12">
                <label for="table">Catégorie</label>
                <select name="table" class="form-control" title="Catégorie">
                    ...
                    <option value="users_courses" <?php if($selectTable == 'users_courses') { echo 'selected'; }?>>
                        Associations cours-utilisateur
                    </option>
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <input class="form-control input input-medium auto-clear placeholder" type="text" placeholder="Auteur" 
                       title="Auteur" name="author" 
