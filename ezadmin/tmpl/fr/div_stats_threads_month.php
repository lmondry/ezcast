...
if (isset($_SESSION['monthStats'])) {
    ...
    <h4>Totaux</h4>
    <p class="default">Nombre de discussions   <span class="label label-default"><?php echo $threadsCountMonth; ?></span></p>
    <p class="default">Nombre de commentaires   <span class="label label-default"><?php echo $commentsCountMonth; ?></span></p>
    <br />
