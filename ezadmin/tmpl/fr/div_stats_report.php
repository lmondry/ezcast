...
<div class="page_title">Rapport</div>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <button type="submit" class="btn btn-block btn-success" 
                        data-loading-text="<img style='height: 16px;' src='img/loading_transparent.gif'/> Chargement..."
    ...
    <tbody> 
        <tr data-toggle="collapse" data-target=".list_all_author" class="collapsed accordion-toggle" 
            ...
            <td>
                ...
                Total auteurs (utilisateurs ayant soumis des videos via EZManager et/ou ayant enregistré en auditoire)
            </td> 
            <?php if($general) { ?>
        ...
        <tr data-toggle="collapse" data-target=".list_submit_author" class="collapsed accordion-toggle" 
            ...
            <td>
                <span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span>
                Auteurs différents ayant soumis des videos via EZManager
            </td> 
            <?php if($general) { ?>
        ...
        <tr data-toggle="collapse" data-target=".list_record_author" class="collapsed accordion-toggle" 
            ...
            <td>
                <span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span>
                Auteurs ayant enregistré en auditoire
            </td> 
            <?php if($general) { ?>
        ...
        <tr data-toggle="collapse" data-target=".list_cours" class="collapsed accordion-toggle" 
            ...
            <td>
                <span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span>
                Total cours (contenant des vidéos soumises via EZManager et/ou des enregistrements en auditoire)
            </td> 
            <?php if($general) { ?>
        ...
        <tr data-toggle="collapse" data-target=".list_cours_submit" class="collapsed accordion-toggle" 
            ...
            <td>
                <span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span>
                Cours contenant des vidéos soumises via EZManager
            </td> 
            <?php if($general) { ?>
        ...
        <tr data-toggle="collapse" data-target=".list_cours_record" class="collapsed accordion-toggle" 
            ...
            <td>
                <span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span>
                Cours contenant des enregistrements faits en auditoire
            </td> 
            <?php if($general) { ?>
        ...
        <tr> 
            <td>
                Total assets (soumis via EZManager + cours enregistrés)
        ...
        <tr> 
            <td>
                Total assets soumis via EZManager
                <p class="help-block" style="margin: 1px;">
                    <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
                    Ne tient pas compte des assets supprimés ni des tests 
                </p>
        ...
        <tr> 
            <td>
                Total assets enregistrés en auditoire
                <p class="help-block" style="margin: 1px;">
                    <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
                    Ne tient pas compte des assets supprimés ni des tests 
                </p>
...
<table class="table table-bordered table-hover"> 
    ...
    <tbody> 
        <tr> 
            <td>
                Total d'utilisateurs différents
            </td>
            <?php if($general) { ?>
        ...
        <tr> 
            <td>
                Total de signets (personnels et officiels) ajoutés (traces)
            </td>
            <?php if($general) { ?>
        ...
        <tr> 
            <td>
                Total de signets officiels ajoutés (traces)
            </td>
            <?php if($general) { ?>
        ...
        <tr> 
            <td>
                Total de signets personnels ajoutés (traces)
            </td>
            <?php if($general) { ?>
        ...
        <tr> 
            <td>
                Total d'utilisateurs ayant ajouté des signets officiels (traces)
            </td>
            <?php if($general) { ?>
        ...
        <tr> 
            <td>
                Total d'utilisateurs ayant ajouté des signets personnels (traces)
            </td>
            <?php if($general) { ?>
...
<div class="col-md-12">
    ...
    <div class="progress">
        ...
        <div class="progress-bar progress-bar-info" style="width: <?php echo $percentClassrooms; ?>%">
            <?php echo $percentClassrooms; ?>% vidéos enregistrées
        </div>
    </div>
</div>
...
<div class="col-md-10">
    ...
    $(function () {
        $('#container_classroom_util').highcharts({
            ...
            series: [{
                type: 'column',
                name: "<?php echo ucfirst("Temps d'enregistrements"); ?>",
                yAxis: 1,
                data: [<?php echo implode(', ', array_map(function ($ar) {return $ar['time'];}, $allClassRoom)); ?>]

            }, {
                type: 'column',
                name: "<?php echo ucfirst("enregistrement"); ?>",
    ...
    <table class="table table-bordered table-hover"> 
        ...
        <tbody> 
            <tr data-toggle="collapse" data-target=".list_user_login" class="collapsed accordion-toggle" 
                ...
                <td>
                    <span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span>
                    Utilisateurs authentifiés différents pour la période donnée
                </td>
            ...
            <tr>
                <td colspan="3" class="hidden_row">
                    <div class="accordian-body collapse list_user_login" style="padding: 5px" id="list_user_login" 
                        ...
                        <div class="col-md-2"><b>Connexions</b></div>
                        <div class="col-md-10"><b>Utilisateur (id)</b></div>
                        <?php $i=0;
            ...
            <tr> 
                <td>
                    Utilisateurs anonymes pour la période donnée 
                </td>
            ...
            <tr>
                <td colspan="3" class="hidden_row">
                    <div class="accordian-body collapse list_user_browser" style="padding: 5px" id="list_user_browser" 
                        ...
                        <div class="col-md-2 text-right"><b>Connexions</b></div>
            ...
            <tr data-toggle="collapse" data-target=".list_album" class="collapsed accordion-toggle" 
                ...
                <td>
                    <span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span>
                    Albums consultés pour la période donnée (parcourir l'album, sans forcément cliquer sur un asset)
                </td>
            ...
            <tr data-toggle="collapse" data-target=".list_album_click" class="collapsed accordion-toggle" 
                ...
                <td>
                    <span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span>
                    Albums contenant au moins un asset ayant été consulté pour la période donnée.
                    <p class="help-block" style="margin: 1px;">
                        <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
                        Contrairement aux albums consultés, qui peuvent avoir été parcourus sans avoir cliqué sur 
            aucune vidéo, ce nombre-ci ne tient compte que des albums dans lesquels au moins un utilisateur a consulté au moins un asset.
                    </p>
                </td>
            ...
            <tr> 
                <td>
                    Assets consultés pour la période donnée
                </td>
            ...
            <tr> 
                <td>
                    Total consultations d'asset pour la période donnée
                    <p class="help-block" style="margin: 1px;">
                        <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
                        Un même utilisateur est compté plusieurs fois s'il regarde plusieurs fois le même asset
                    </p>
                </td>
            ...
            <tr>
                <td colspan="3" class="hidden_row">
                    <div class="accordian-body collapse unique_asset" style="padding: 5px" id="unique_asset" 
                        ...
                        <div class="col-md-2"><b>Consulations</b></div>
            ...
            <tr data-toggle="collapse" data-target=".cours_pers_bookmark" class="collapsed accordion-toggle" 
                ...
                <td colspan="2">
                    <span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span>
                    Cours dans lesquels le plus de signets personnels ont été ajoutés
                </td>
            </tr>
            <tr>
                <td colspan="3" class="hidden_row">
                    <div class="accordian-body collapse cours_pers_bookmark" style="padding: 5px" id="cours_pers_bookmark" 
                        ...
                        <div class="col-md-2"><b>Signet(s) ajouté(s)</b></div>
            ...
            <tr data-toggle="collapse" data-target=".user_offi_bookmark" class="collapsed accordion-toggle" 
                ...
                <td colspan="2">
                    <span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span>
                    Utilisateurs ayant le plus de signets officiels
                </td>
            </tr>
            <tr>
                <td colspan="3" class="hidden_row">
    ...
    <div class="col-md-12">
        ...
        $(function() {
            ...
            $('#container_asset_view').highcharts('StockChart', {
                ...
                title : {
                    text : "Répartition des vues assets"
                },
                series : [{
                    type: 'column',
                    name : "Nombre d'asset",
...
$(function () {
    $('#container_status_percent').highcharts({
        ...
        title: {
            text: "Proportion<br />d'enregistrements<br />réussis",
            align: 'center',
        ...
        series: [{
            ...
            innerSize: '50%',
            data: [
                ["Réussi",   <?php echo $percentSuccess; ?>],
                ["Echec",       <?php echo $percentError; ?>]
            ]
        }]
    });
});    
...
$(function () {
    $('#container_camslide_graph').highcharts({
        ...
        title: {
            text: "Répartition des<br />enregistrements camslide"
        },
        tooltip: {
            pointFormat: '<b>{point.percentage:.1f}%</b>'
        },
...
$(function() {
    ...
    $('#container_status_date').highcharts('StockChart', {
        ...
        title : {
            text : "Somme des enregistrements réussis et ratés"
        },
        legend: {
            enabled: true,
            align: 'right',
...
$(function() {
    ...
    $('#container_os').highcharts({
        ...
        title: {
            text: "Système d'exploitation utilisé"
        },
        tooltip: {
            pointFormat: '<b>{point.percentage:.1f}%</b>'
        },
