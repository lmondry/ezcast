...
if (isset($_SESSION['nDaysStats'])) {
    ...
    <script>
        var pieChartNDays = jQuery.jqplot('pieChartNDays', [dataArrayPieChartNDays],
                {
                    title: 'Number of discussions by album [<?php echo substr($_SESSION['nDaysStats']['nDaysEarlier'], 0, 10); ?> - <?php echo substr($_SESSION['nDaysStats']['nDaysLater'], 0, 10); ?>]',
                    seriesDefaults: {
    ...
    <h4>Totals</h4>
    <p class="default">Number of discussions    <span class="label label-default"><?php echo $threadsCountNDays; ?></span></p>
    <p class="default">Number of comments   <span class="label label-default"><?php echo $commentsCountNDays; ?></span></p>
