                        ...
                        <div class="panel-body well" style="margin-bottom:0;">
                            <div class="row">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label">Organization logo
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Repository root path</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Application root path</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">PHP cli command</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Rsync command</label>
                                        <div class="controls">
                        ...
                        <div class="panel-body well" style="margin-bottom:0;">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Database's name</label>
                                        <div class="controls">
