...
<div class="table-responsive">
    <table class="table table-striped table-hover table-bordered table-condensed events sort_col">
        <tr>
            ...
            <?php echo $colOrder->insertThSort("classroom_id", "Classroom"); ?>
            <?php echo $colOrder->insertThSort("course", "Courses"); ?>
            <?php echo $colOrder->insertThSort("author", "Author"); ?>
            <?php echo $colOrder->insertThSort("cam_slide", "Record Type"); ?>
            <?php echo $colOrder->insertThSort("event_time", "Date"); ?>
            <?php echo $colOrder->insertThSort("type_id", "Type"); ?>
            <?php echo $colOrder->insertThSort("context", "Context"); ?>
