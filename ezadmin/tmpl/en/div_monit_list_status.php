...
if(isset($errorActionMsg)) { ?>
    ...
    An error occured with parameters (<?php echo $errorActionMsg; ?>)
    </div>
<?php }

if(isset($cronWarningMsg) && $cronWarningMsg) { ?>
    <div class="alert alert-warning col-md-10 col-md-offset-1" role="alert">
    Warning, no status has been posted for a certaine time. Check the 
            "cron" task.<br />
            If it was disabled, run this script: 
...
<div class="table-responsive col-md-12">
    <table class="table table-striped table-hover table-bordered events sort_col">
        <tr>
            ...
            <?php echo $colOrder->insertThSort("status_time", "Status date"); ?>
            <?php echo $colOrder->insertThSort("author", "Author"); ?>
            <?php echo $colOrder->insertThSort("status", "Status"); ?>
            <th>Message</th>
        </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Define parent</h4>
                </div>
                <form method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="parent_asset" class="control-label">Parent asset name:</label>
                            <input type="text" class="form-control" id="parent_asset" placeholder="Asset" name="parent_asset">
                            <span id="helpBlock" class="help-block">
                                <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span> 
                                The status of the current asset will be automatically set to Ignore
                            </span>
                        </div>
                    </div>
