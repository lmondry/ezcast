            ...
            <?php if ($public_album) { ?>
                <li><span class="BoutonDeplacerAlbumPrive">
                        ...
                        if ($status != 'processing' && $status != 'error') {
                            ?>
                            <a href="javascript:show_popup_from_inner_div('#popup_unpublish_asset_<?php echo $asset_name; ?>');">Move to private album</a>
                            <?php
                        } else {
                            ?>
                            <a href="javascript:show_popup_from_inner_div('#popup_not_available');">Move to private album</a>
                            <?php
                        }
                        ?>
                    </span></li>
                ...
                <?php if ($status != 'processing' && $status != 'error') { ?>
                            <a href="javascript:show_popup_from_inner_div('#popup_publish_asset_<?php echo $asset_name; ?>');">Move to public album</a>
                            <?php
                        } else {
                            ?>
                            <a href="javascript:show_popup_from_inner_div('#popup_not_available');">Move to public album</a>
                            <?php
                        }
                        ?>
                    </span></li>
                    ...
                    <?php if ($status != 'processing' && $status != 'error') { ?>
                        <a href="javascript:show_popup_from_inner_div('#popup_schedule_<?php echo $asset_name; ?>');">Schedule</a>
                        <?php
                    } else {
                        ?>
                        <a href="javascript:show_popup_from_inner_div('#popup_not_available');">Schedule</a>
                        <?php
                    }
                    ?>
                </span></li>
...
<div class="Colonne-Un-Information">
    ...
    <p><span class="infospodast">Origin&nbsp;:</span> <?php if ($origin == 'SUBMIT') echo 'Manual submit';
...
<?php if ($status == 'processing') {
    ?>
        ...
        ?>
        <p><span class="infospodast">Status&nbsp;:</span> <span style="color: red;">Processing error</span></p>
        <?php
    } else {
        ?>
