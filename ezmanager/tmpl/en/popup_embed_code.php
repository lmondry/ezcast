...
<div class="popup" id="popup_embed_code">
    <h2>Embed</h2>
    You may include this video in another page by copypasting the following code:  <br/><br/>
    ...
    <!--[if IE]>
    <span id="copy_button" class="Bouton"><a href="#" onclick="window.clipboardData.setData('Text','<?php echo $embed_code; ?>');"><span>Copy to clipboard</span></a></span>
    <![endif]-->
</div>
