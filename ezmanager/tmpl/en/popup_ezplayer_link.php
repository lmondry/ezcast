...
<div class="popup" id="popup_ezplayer_link" >
    <h2>EZplayer link</h2>
    Use this link to share the recording through EZplayer:  <br/><br/>
    ...
    <!--[if IE]>
    <span id="copy_button" class="Bouton"><a href="#" onclick="window.clipboardData.setData('Text','<?php echo $ezplayer_link; ?>');"><span>Copy to clipboard</span></a></span>
    <![endif]-->
</div>
