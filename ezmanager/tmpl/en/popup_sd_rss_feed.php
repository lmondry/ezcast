...
<div class="popup" id="SD_RSS_box" style="width:600px">
    <h2>Low resolution RSS feed</h2>
    You can watch or broadcast this album in low definition by using the following link: <br/><br/>
    ...
    <div id="wrapper_clip" style="position:relative">
        <span id="copy_button_sd_rss" class="Bouton"><a><span id="copy_button_text_sd_rss">Copy to clipboard</span></a></span>
    ...
    <!--[if IE]>
    <span id="copy_button_sd_rss" class="Bouton"><a href="#" onclick="window.clipboardData.setData('Text','<?php echo $sd_rss_url_web; ?>');"><span>Copy to clipboard</span></a></span>
    <![endif]-->
</div>
