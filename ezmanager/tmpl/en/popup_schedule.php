...
<div class="popup" id="popup_schedule_<?php echo $asset_name; ?>">
    ...
    <?php if ($asset_scheduled) { ?>
        The recording will be moved on  
        <?php
        ...
        ?>
        <br/><br/>
        Do you want to cancel the scheduling ? 
        <br/><br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span class="Bouton"> <a href="?action=cancel_schedule_asset&album=<?php echo $album; ?>&asset=<?php echo $asset_name; ?>"><span>Delete the scheduling</span></a></span>

    <?php } else { ?>
        <br/>Select the date and hour you want the recording to be published / archived<br/><br/>
        <form  action="index.php" onsubmit="return false;" method="post" id="schedule_form">
            ...
            <div id="submitButton">
                ...
                <span class="Bouton"><a href="javascript:submit_schedule_form();"><span>Schedule</span></a></span>
            </div>
            <script >
