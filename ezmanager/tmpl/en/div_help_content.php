...
<div id="Bloc-ensemble">
     ...
     <div class="Helpnew">
      ...
      <p><br />
        Ce tutoriel existe au format .pdf ; vous pouvez le télécharger dans l'<em>Espace enseignants</em> du site "<a href="http://podcast.ulb.ac.be" target="_blank">ULB Podcast</a>".</p>
<p>&nbsp;</p>
