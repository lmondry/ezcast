    ...
    <div class="BlocPodcastMenu">
        ...
        if (isset($assets) && !empty($assets)) {
            foreach ($assets as $asset) {
                ...
                ?>
                <div>
                    <input class="custom-checkbox" name="asset_downloadable" id="is_downloadable_<?php echo $asset_name; ?>" title="Allow download" type="checkbox" 
                           ...
                           >                    
                    <label onclick="$('#is_downloadable_<?php echo $asset_name; ?>').click();" title="Allow download" >
                    </label>
