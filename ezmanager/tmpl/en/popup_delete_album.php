...
<div class="popup" id="popup_delete_album">
    <h2>Delete this album <?php echo $album_name; ?>?</h2>
    <span class="warning"><strong>Caution: </strong>destructive, non-reversible operation.<br/><br/></span>
    <div><strong>Caution </strong>you are about to delete the albums for <?php echo $album_name; ?>. By doing so, you will delete both the <strong>public</strong> <i>and</i> <strong>private</strong> albums, as well as all of their content. The other owners of the album will also lose access to this album.</div><br/>
