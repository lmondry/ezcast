...
<div class="popup" id="submit_media" style="width: 415px;height: 665px;">
    <h2 style="display:inline;">Submit a new record</h2>
    ...
    <div id="form">
        ...
        ?>/index.php" method="post" id="submit_form" enctype="multipart/form-data" onsubmit="return false" target="uploadFrame">
            ...
            <p>Album&nbsp;: <?php echo $album; ?> (<?php echo ($moderation) ? 'Private album' : 'Public album'; ?>)</p>
            ...
            <div id='submit_type'>
                ...
                <select id="type" name="type" onchange="show_file_input();">
                    <option selected="selected"  value="cam">Camera movie file</option>
                    <option value="slide">Slide movie file</option>
                    <option value="camslide">Camera slide movie files</option>
                </select>   
            </div>
            <!-- Title field -->           
            <label>Title&nbsp;:
                <span class="small">Max. 70 characters</span>
            </label>
            ...
            <span id="more_options_button" class="BoutonMoreOptions"><a onclick="getElementById('more_options_button').className == 'BoutonMoreOptionsClic' ? getElementById('more_options_button').className = 'BoutonMoreOptions' : getElementById('more_options_button').className = 'BoutonMoreOptionsClic'" href="javascript:show_div('more_options_div')">More</a></span>
            <br />
            <div class="spacer"></div>
            ...
            <div id="more_options_div" style="display:none;">
                ...
                <label>Jingle&nbsp;: 
                    <span class="small"><a class="info small">More info<span>Animation added before the actual video.</span></a></span>
                </label>
                ...
                <label>Titling&nbsp;:                      
                    <span class="small"><a class="info small">More info<span>Information displayed after the jingle. The default titling contains the album name, the title, the author and the date of publication of the video.</span></a></span>
                </label>
                ...
                <label>Closing crédits&nbsp;: 
                    <span class="small"><a class="info small">More info<span>Animation added after the actual video.</span></a></span>
                </label>
                ...
                <br/><br/>
                <label>Aspect ratio&nbsp;:                      
                    <span class="small"><a class="info small">More info<span>Forces the aspect ratio for the video (no letterboxing will be added and the output video might be distorted).</span></a></span>
                </label>    
                <div id='ratio'>    
                ...
                <label class="labelcb" for="keepQuality">&nbsp;Keep the original video quality</label>
                <div class="spacer"></div>
                <div style="display: none; color: red;" id="only_small_files_message">
                    Please only use with short videos.
                </div>
                ...
                <label class="labelcb" for="downloadable"><span><a class="info" style="font-size: 11px;">Allow download<span style="font-weight: normal; font-size: 10px;">If this box is checked, the submitted video will be downloadable via EZplayer. </span></a></span></label>
            ...
            <div id='submit_slide' style="display: none;">
                <label id="loadingfile_label2"> 
                    File&nbsp;:
                    <span id='file_info2' class="small">Slide movie file</span>
                </label>
                <!--input id="loadingfile" type="file" name="media"/> <br/><br /-->
            ...
            <!-- show more options -->   
            <!--a class="greyLink" id="more_options_a" style="border:none;" href="#" onclick="show_div('more_options_div')">More</a-->
    ...
    <script type="text/javascript">
        ...
        if (is_xhr2) {
            document.getElementById('file_info').innerHTML = 'Camera movie file';
        } else {
        ...
        function show_file_input() {
            if (document.getElementById('type').value === 'camslide') {
                ...
                type = (document.getElementById('type').value == 'cam') ? 'Camera movie file' : 'Slide movie file';
        ...
        function check_form() {
            ...
            if (file == '') {
                ...
                if (document.getElementById('type').value === 'camslide') {
                    ...
                    if (file2 == '') {
                        window.alert('Please select a file (Slide movie file)');
                        return false;
                    }
                    ...
                    if (!found) {
                        window.alert('Bad extension (Slide movie file)');
                        return false;
                    }
                }
            }
        ...
        function updateProgress(progressRate, type) {
            // upload is finished 
            if (document.getElementById('type').value === 'camslide') {
                type = (type == 'cam') ? '[Camera movie file] ' : '[Slide movie file] ';
            } else {
                type = '';
            }

            if (progressRate >= 100) {
                document.getElementById('submit_media').innerHTML = '<h2>File submitted</h2>File uploaded and ready for processing<br/><br/><br/><span class="Bouton"><a href="#" onclick="close_popup();"><span>Close</span></a></span>';
            } else {
                ...
                document.getElementById('submitButton').innerHTML = type + 'Upload in progress ... (' + (isNaN(progressRate) ? '0' : progressRate) + '%)';
            }
        }
        ...
        function sendRequest() {
            ...
            if (is_xhr2) {
                        ...
                        worker.onmessage = function (e) {
                            ...
                            switch (e.data.action) {
                                ...
                                case 'error':
                                    ...
                                    xhr2.send(fd2);
                                    document.getElementById('submit_media').innerHTML = '<h2>Submit failed</h2>An error occured during the file upload. Try again.<br/><br/><br/><span class="Bouton"><a href="#" onclick="close_popup();"><span>Close</span></a></span>';
                ...
                document.getElementById('submit_cam').style.display = 'none';
                document.getElementById('submitButton').innerHTML = 'File is being uploaded. Please wait till the end of the upload to close this window. A message will appear when the file upload is finished.<br/><br/><img src="images/loading_white.gif"/>';
