...
<div class="popup" id="HD_RSS_box" style="width:600px;">
    <h2>High resolution RSS feed</h2>
    You can watch or broadcast this album in high definition by using the following link: <br/><br/>
    ...
    <div id="wrapper_clip" style="position:relative">
        <span id="copy_button_hd_rss" class="Bouton"><a><span id="copy_button_text_hd_rss">Copy to clipboard</span></a></span>
    ...
    <!--[if IE]>
    <span id="copy_button_hd_rss" class="Bouton"><a href="#" onclick="window.clipboardData.setData('Text','<?php echo $hd_rss_url_web; ?>');"><span>Copy to clipboard</span></a></span>
    <![endif]-->
</div>
