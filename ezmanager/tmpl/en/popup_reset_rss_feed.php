...
<div class="popup" id="popup_reset_rss_feed">
    <h2>Reset RSS?</h2>
    <span class="warning"><strong>Caution: </strong>non-reversible operation.</span><br/><br/>
    <div>The RSS feed will be reset. All subscribers will lose their access to the album.</div><br/>
