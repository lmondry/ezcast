...
<div class="popup" id="popup_edit_album" style="width: 415px; height: 300px;">
    ...
    <div id="form">
        <form  action="index.php" onsubmit="return false;" method="post" id="edit_form">
            ...
            <p>
                Album&nbsp;: <?php echo $album; ?> (<?php echo ($moderation) ? 'Private album' : 'Public album'; ?>)
                <br/><br/>

                <!-- Jingle dropdown list -->
                <label>Jingle&nbsp;:
                    <span class="small"><a class="info small">More info<span>Animation added before the actual video.</span></a></span></label>   
                ...
                <label>Titling&nbsp;:
                    <span class="small"><a class="info small">More info<span>Information displayed after the jingle. The default titling contains the album name, the title, the author and the date of publication of the video.</span></a></span></label>
...
?>
                ...
                <label class="labelcb" for="downloadable"><span><a class="info">Allow download<span style="font-weight: normal; font-size: 10px;">If this box is checked, the videos contained in this album will be downloadable via EZplayer. This change only applies to upcoming videos. </span></a></span></label>
