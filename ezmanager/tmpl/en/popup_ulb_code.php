...
<div class="popup" id="popup_ulb_code" style="width: 400px;">
    <h2>Site Manager</h2>
    This code contains information about the video:  <br/><br/>
    ...
    <!--[if IE]>
    <span id="copy_button" class="Bouton"><a href="#" onclick="window.clipboardData.setData('Text','<?php echo $ulb_code; ?>');"><span>Copy to clipboard</span></a></span>
    <![endif]-->
</div>
