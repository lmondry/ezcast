...
<div class="popup" id="player_url_box" style="width:600px;">
    <h2>EZplayer link</h2>
    You can watch or broadcast this album via EZplayer, the rich media player, by using the following link: <br/><br/>
    ...
    <div id="wrapper_clip" style="position:relative">
        <span id="copy_player_url" class="Bouton"><a><span id="copy_button_text_player_url">Copy to clipboard</span></a></span>
    ...
    <!--[if IE]>
    <span id="copy_button_player_url" class="Bouton"><a href="#" onclick="window.clipboardData.setData('Text','<?php echo $player_full_url; ?>');"><span>Copy to clipboard</span></a></span>
    <![endif]-->
</div>
