        ...
        <script type="text/javascript">
            ...
            function copyToClipboard(album, tocopy) {
                ...
                clip.addEventListener('onComplete', function () {
                    alert("Content saved in the clipboard");
                });
...
?>) {
                    window.alert('Title too long (max. <?php echo $title_max_length; ?> characters).');
                    return false;
                }
