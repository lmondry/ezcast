...
<div class="popup" id="submit_media" style="width: 415px;height: 665px;">
    <h2 style="display:inline;">Soumettre un enregistrement</h2>
    ...
    <div id="form">
        ...
        ?>/index.php" method="post" id="submit_form" enctype="multipart/form-data" onsubmit="return false" target="uploadFrame">
            ...
            <p>Album&nbsp;: <?php echo $album; ?> (<?php echo ($moderation) ? 'Album privé' : 'Album public'; ?>)</p>
            ...
            <div id='submit_type'>
                ...
                <select id="type" name="type" onchange="show_file_input();">
                    <option selected="selected"  value="cam">Vidéo caméra</option>
                    <option value="slide">Vidéo diaporama</option>
                    <option value="camslide">Vidéos caméra - diaporama</option>
                </select>   
            </div>
            <!-- Title field -->           
            <label>Titre&nbsp;:
            ...
            <span id="more_options_button" class="BoutonMoreOptions"><a onclick="getElementById('more_options_button').className == 'BoutonMoreOptionsClic' ? getElementById('more_options_button').className = 'BoutonMoreOptions' : getElementById('more_options_button').className = 'BoutonMoreOptionsClic'" href="javascript:show_div('more_options_div')">Options avancées</a></span>
            <br />
            <div class="spacer"></div>
            ...
            <div id="more_options_div" style="display:none;">
                ...
                <label>Générique&nbsp;: 
                    <span class="small"><a class="info small">En savoir plus<span>Animation visuelle ajoutée en début de vidéo.</span></a></span>
                </label>
                ...
                <label>Titrage&nbsp;:                      
                    <span class="small"><a class="info small">En savoir plus<span>Information affichée après le générique, en début de vidéo. Le titrage par défaut reprend l'album dans lequel est soumise la vidéo, le titre, l'auteur et la date de publication de la vidéo.</span></a></span>
                </label>
                ...
                <label>Générique fin&nbsp;: 
                    <span class="small"><a class="info small">En savoir plus<span>Animation visuelle ajoutée en fin de vidéo.</span></a></span>
                </label>
                ...
                <label>Format d'image&nbsp;:                      
                    <span class="small"><a class="info small">En savoir plus<span>Force le format d'image pour la vidéo (aucun bord ne sera rajouté, donc l'image pourrait être déformée).</span></a></span>
                </label>    
                <div id='ratio'>    
                ...
                <label class="labelcb" for="keepQuality">&nbsp;Garder la qualité originale</label>
                <div class="spacer"></div>
                <div style="display: none; color: red;" id="only_small_files_message">
                    Attention, à n'utiliser qu'avec des vidéos de courte durée.
                </div>
                ...
                <label class="labelcb" for="downloadable"><span><a class="info" style="font-size: 11px;">Vidéo téléchargeable<span style="font-weight: normal; font-size: 10px;">Si cette case est cochée, la vidéo soumise pourra être téléchargée via EZplayer.</span></a></span></label>
            ...
            <div id='submit_cam'>
                <label id="loadingfile_label"> 
                    Fichier&nbsp;:
                    <span id='file_info' class="small">Max. 2Go</span>
                </label>
            ...
            <div id='submit_slide' style="display: none;">
                <label id="loadingfile_label2"> 
                    Fichier&nbsp;:
                    <span id='file_info2' class="small">Vidéo diaporama</span>
                </label>
                <!--input id="loadingfile" type="file" name="media"/> <br/><br /-->
            ...
            <div id="submitButton">
                <button onclick="if (check_form())
                            sendRequest()">Soumettre</button>
            </div>
            <br />

            <!-- show more options -->   
            <!--a class="greyLink" id="more_options_a" style="border:none;" href="#" onclick="show_div('more_options_div')">Options avancées</a-->
    ...
    <script type="text/javascript">
        ...
        if (is_xhr2) {
            document.getElementById('file_info').innerHTML = 'Vidéo caméra';
        } else {
        ...
        function show_file_input() {
            if (document.getElementById('type').value === 'camslide') {
                ...
                type = (document.getElementById('type').value == 'cam') ? 'Vidéo caméra' : 'Vidéo diaporama';
        ...
        function check_form() {
            ...
            if (file == '') {
                ...
                if (document.getElementById('type').value === 'camslide') {
                    ...
                    if (file2 == '') {
                        window.alert('Veuillez sélectionner un fichier (Vidéo diaporama)');
                        return false;
                    }
                    ...
                    if (!found) {
                        window.alert('Type de fichier non reconnu (Vidéo diaporama)');
                        return false;
                    }
                }
            }
        ...
        function updateProgress(progressRate, type) {
            // upload is finished 
            if (document.getElementById('type').value === 'camslide') {
                type = (type == 'cam') ? '[Vidéo caméra] ' : '[Vidéo diaporama] ';
            } else {
                type = '';
            }

            if (progressRate >= 100) {
                document.getElementById('submit_media').innerHTML = '<h2>Envoi terminé</h2>Fichier envoyé et en cours de traitement<br/><br/><br/><span class="Bouton"><a href="#" onclick="close_popup();"><span>Fermer</span></a></span>';
            } else {
                ...
                document.getElementById('submitButton').innerHTML = type + 'Fichier en cours d\'envoi ... (' + (isNaN(progressRate) ? '0' : progressRate) + '%)';
            }
        }
        ...
        function sendRequest() {
            ...
            if (is_xhr2) {
                        ...
                        worker.onmessage = function (e) {
                            ...
                            switch (e.data.action) {
                                ...
                                case 'error':
                                    ...
                                    xhr2.send(fd2);
                                    document.getElementById('submit_media').innerHTML = '<h2>Envoi en erreur</h2>Une erreur est survenue lors de l\'envoi du fichier. Veuillez réessayer.<br/><br/><br/><span class="Bouton"><a href="#" onclick="close_popup();"><span>Fermer</span></a></span>';
                ...
                document.getElementById('submit_cam').style.display = 'none';
                document.getElementById('submitButton').innerHTML = 'Le fichier est en cours d\'envoi. Veuillez patienter jusqu\'à la fin du téléchargement pour fermer la fenêtre. Un message apparaitra à la fin du téléchargement.<br/><br/><img src="images/loading_white.gif"/>';
