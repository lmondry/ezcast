...
<div class="popup" id="popup_ezplayer_link" >
    <h2>Lien EZplayer</h2>
    Utilisez ce lien pour partager l'enregistrement via EZplayer:   <br/><br/>
    ...
    <!--[if IE]>
    <span id="copy_button" class="Bouton"><a href="#" onclick="window.clipboardData.setData('Text','<?php echo $ezplayer_link; ?>');"><span>Copier dans le presse-papier</span></a></span>
    <![endif]-->
</div>
