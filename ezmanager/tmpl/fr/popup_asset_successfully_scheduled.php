...
<div class="popup" id="popup_album_successfully_edited">
    <h2>Programmation d'asset terminée</h2>
    <?php if ($action == "publish"){ ?>
        L'enregistrement sera placé dans l'album public le 
    <?php } else { ?>
        L'enregistrement sera placé dans l'album privé le 
    <?php } 
    ...
    <br/>
    <br/>
    <span class="Bouton"> <a href="index.php"><span>Fermer</span></a></span>
</div>