...
<div class="popup" id="popup_schedule_<?php echo $asset_name; ?>">
    <h2>Programmer</h2>
    <strong>Titre&nbsp;: </strong><?php echo htmlspecialchars($title); ?><br/><br/>
    <?php if ($asset_scheduled) { ?>
        L'enregistrement sera déplacé le  
        <?php
        ...
        ?>
        <br/><br/>
        Souhaitez-vous annuler la programmation ?  
        <br/><br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span class="Bouton"> <a href="?action=cancel_schedule_asset&album=<?php echo $album; ?>&asset=<?php echo $asset_name; ?>"><span>Supprimer la programmation</span></a></span>

    <?php } else { ?>
        <br/>Sélectionnez la date et heure à laquelle vous souhaitez que  l'enregistrement soit publié / archivé<br/><br/>
        <form  action="index.php" onsubmit="return false;" method="post" id="schedule_form">
            ...
            <div id="submitButton">
                ...
                <span class="Bouton"><a href="javascript:submit_schedule_form();"><span>Programmer</span></a></span>
            </div>
            <script >
