...
<div class="popup" id="popup_edit_album" style="width: 415px; height: 300px;">
    ...
    <div id="form">
        <form  action="index.php" onsubmit="return false;" method="post" id="edit_form">
            ...
            <p>
                Album&nbsp;: <?php echo $album; ?> (<?php echo ($moderation) ? 'Album privé' : 'Album public'; ?>)
                <br/><br/>

                <!-- Jingle dropdown list -->
                <label>Générique&nbsp;:
                    <span class="small"><a class="info small">En savoir plus<span>Animation visuelle ajoutée en début de vidéo.</span></a></span></label>   
                ...
                <label>Titrage&nbsp;:
                    <span class="small"><a class="info small">En savoir plus<span>Information affichée après le générique, en début de vidéo. Le titrage par défaut reprend l'album dans lequel est soumise la vidéo, le titre, l'auteur et la date de publication de la vidéo.</span></a></span></label>
...
?>
                ...
                <label class="labelcb" for="downloadable"><span><a class="info">Vidéos téléchargeables<span style="font-weight: normal; font-size: 10px;">Si cette case est cochée, les vidéos soumises dans l'album pourront être téléchargées via EZplayer. Cette modification ne s'applique que pour les futures vidéos. </span></a></span></label>
            <div class="spacer"></div>

            <br/><br/>
            <div id="submitButton">
                <!-- <span class="Bouton"><span><input type="submit" value="Soumettre" /></span></span> -->
                <!--span class="Bouton"><a href="javascript:document.forms['edit_form'].submit();"><span>Sauvegarder</span></a></span-->
                <span class="Bouton"><a href="javascript:submit_edit_form();"><span>Sauvegarder</span></a></span>
            </div>
            <script >
