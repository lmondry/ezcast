...
<div class="popup" id="HD_RSS_box" style="width:600px;">
    <h2>Flux RSS haute résolution</h2>
    Pour consulter ou distribuer cet album en haute définition, veuillez utiliser le lien suivant : <br/><br/>
    ...
    <div id="wrapper_clip" style="position:relative">
        <span id="copy_button_hd_rss" class="Bouton"><a><span id="copy_button_text_hd_rss">Copier dans le presse-papier</span></a></span>
    ...
    <!--[if IE]>
    <span id="copy_button_hd_rss" class="Bouton"><a href="#" onclick="window.clipboardData.setData('Text','<?php echo $hd_rss_url_web; ?>');"><span>Copier dans le presse-papier</span></a></span>
    <![endif]-->
</div>
