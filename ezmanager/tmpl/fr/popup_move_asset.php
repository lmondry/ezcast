...
<div class="popup" id="popup_move_asset_<?php echo $asset_name; ?>">
    ...
    //Else, we display the album list
        ...
        Veuillez choisir dans la liste ci-dessous l'album de destination :<br/>
        <table>
        <?php 
        foreach($created_albums_list_with_descriptions as $destination_name => $destination_description) {
            ...
            <!-- Note: upon clicking this link, the JS function defined in show_details_functions.js will call the web_index
                ...
                <td class="album_name">
                    <a href="javascript:popup_asset_move_callback('<?php echo $album; ?>', '<?php echo $destination_name.'-priv'; ?>', '<?php echo $asset_name; ?>');"><?php echo $destination_name; ?> (privé)</a>
                </td>
                <td class="album_description">
                    <a href="javascript:popup_asset_move_callback('<?php echo $album; ?>', '<?php echo $destination_name.'-priv'; ?>', '<?php echo $asset_name; ?>');"><?php echo $destination_description; ?> (Album privé)</a>
                </td>
            </tr>
            <tr>
            <!-- Note: upon clicking this link, the JS function defined in show_details_functions.js will call the web_index
                ...
                <td class="album_description">
                    <a href="javascript:popup_asset_move_callback('<?php echo $album; ?>', '<?php echo $destination_name.'-pub'; ?>', '<?php echo $asset_name; ?>');"><?php echo $destination_description; ?> (Album public)</a>
                </td>
            </tr>
            <?php
        }
