...
<div class="popup" id="player_url_box" style="width:600px;">
    <h2>Lien EZplayer</h2>
    Pour consulter ou distribuer cet album via le lecteur enrichi "EZplayer", veuillez utiliser le lien suivant : <br/><br/>
    ...
    <div id="wrapper_clip" style="position:relative">
        <span id="copy_player_url" class="Bouton"><a><span id="copy_button_text_player_url">Copier dans le presse-papier</span></a></span>
    ...
    <!--[if IE]>
    <span id="copy_button_player_url" class="Bouton"><a href="#" onclick="window.clipboardData.setData('Text','<?php echo $player_full_url; ?>');"><span>Copier dans le presse-papier</span></a></span>
    <![endif]-->
</div>
