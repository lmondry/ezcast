...
<div class="popup" id="popup_delete_asset_<?php echo $asset_name; ?>">
    <h2>Supprimer l'enregistrement "<?php echo htmlspecialchars($title); ?>"?</h2>
    <span class="warning"><strong>Attention : </strong>opération destructive non-réversible.</span><br/><br/>
