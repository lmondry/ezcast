...
<div class="popup" id="SD_RSS_box" style="width:600px">
    <h2>Flux RSS basse résolution</h2>
    Pour consulter ou distribuer cet album en basse définition, veuillez utiliser le lien suivant : <br/><br/>
    ...
    <div id="wrapper_clip" style="position:relative">
        <span id="copy_button_sd_rss" class="Bouton"><a><span id="copy_button_text_sd_rss">Copier dans le presse-papier</span></a></span>
    ...
    <!--[if IE]>
    <span id="copy_button_sd_rss" class="Bouton"><a href="#" onclick="window.clipboardData.setData('Text','<?php echo $sd_rss_url_web; ?>');"><span>Copier dans le presse-papier</span></a></span>
    <![endif]-->
</div>
