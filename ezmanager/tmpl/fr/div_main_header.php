...
<div class="header">
    <div class="header_content">
        ...
        <a href="index.php?action=logout" title="Déconnexion"><span class="logout">Déconnexion</span></a>
        <span style="float: right; margin: 1px 3px; margin-top: -11px; font-size: 15px;">|</span>
        <a href="index.php?action=view_help" target="_blank"><span class="logout">Aide</span></a> 
    </div>
</div>