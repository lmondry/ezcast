...
<div class="popup" id="popup_media_URL">
    <h2>Vidéo</h2>
    Pour regarder ou distribuer cette vidéo, veuillez utiliser le lien suivant : <br/><br/>
    ...
    <!--[if IE]>
    <span id="copy_button" class="Bouton"><a href="#" onclick="window.clipboardData.setData('Text','<?php echo $media_url_web; ?>');"><span>Copier dans le presse-papier</span></a></span>
    <![endif]-->
</div>
