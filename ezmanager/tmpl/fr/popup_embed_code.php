...
<div class="popup" id="popup_embed_code">
    <h2>Embed</h2>
    Vous pouvez inclure cette vidéo dans une autre page en copiant/collant le code suivant :  <br/><br/>
    ...
    <!--[if IE]>
    <span id="copy_button" class="Bouton"><a href="#" onclick="window.clipboardData.setData('Text','<?php echo $embed_code; ?>');"><span>Copier dans le presse-papier</span></a></span>
    <![endif]-->
</div>
