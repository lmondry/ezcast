...
<div class="popup" id="popup_new_album">
    ...
    <?php if(empty($not_created_albums_with_descriptions)) {
        ?>
        Tous les albums à votre disposition ont déjà été créés
        <?php
    }
    
    //Else, we display the album list
    else { ?>
        Veuillez choisir dans la liste ci-dessous le cours correspondant à l'album que vous désirez créer :<br/>
        <table>
        <?php 
