...
?>) {
                    window.alert('Titre trop long (max. <?php echo $title_max_length; ?> caractères)');
                    return false;
                }
